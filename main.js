...
// only show home section
const body = [banner, about, capability]; // add page section
...
window.addEventListener("orientationchange", function () {
  // Reload the page when display width change
  location.reload();
});
    ...
    navlinks.forEach((e) => {
      e.addEventListener("click", () => {
        ...
        body.forEach(function (item) {
          item.style.display = "none";
          if (
            item.getAttribute("data-effect") == e.getAttribute("data-output")
          ) {
            item.style.display = "flex";
          }
        });
